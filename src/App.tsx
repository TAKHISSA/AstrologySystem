...
? 'url("[https://images.pexels.com/photos/2469122/pexels-photo-2469122.jpeg](https://images.pexels.com/photos/2469122/pexels-photo-2469122.jpeg)")'
: 'url("[https://images.pexels.com/photos/9754/mountains-clouds-forest-fog.jpg](https://images.pexels.com/photos/9754/mountains-clouds-forest-fog.jpg)")',
...
return ( <div className="min-h-screen transition-colors duration-200" style={backgroundStyle}>
{/\* Overlay katmanı \*/} <div className="absolute inset-0 bg-white/30 dark:bg-black/30 backdrop-blur-sm z-0" />
